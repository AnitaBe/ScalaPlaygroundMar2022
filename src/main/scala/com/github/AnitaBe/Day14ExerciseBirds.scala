...
class Chicken(name:String) extends RunningTrait{
  ...
  def layeggs(eggamount:Int):Unit = println(s"com.github.AnitaBe.Chicken $name layed $eggamount eggs!") //chicken also can lay eggs
}
...
class Pigeon(name:String) extends Birds(name:String){
  def eatworms(): Unit = println(s"com.github.AnitaBe.Pigeon $name eat worms!")
}
//TODO create FlightTrait trait with fly method declaration (no need to define it, just declare it)

//TODO create com.github.AnitaBe.RunningTrait with at least run method declaration

//TODO create com.github.AnitaBe.SwimmingTrait with swim method declaration inside

//TODO create com.github.AnitaBe.Penguin class extended with appropriate traits
//TODO create com.github.AnitaBe.Chicken class extended with appropriate traits
