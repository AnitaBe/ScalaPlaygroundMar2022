...
//notice object so singleton meaning we only have one com.github.AnitaBe.Color object
...
object Fingers extends Enumeration {
  type Finger = Value //so all com.github.AnitaBe.Fingers have same type of Value

  val Thumb, Index, Middle, Ring, Little = Value
}

object Days extends Enumeration {
  type Days = Value //so all com.github.AnitaBe.Days have same type of Value
...
object Day16Enumerations extends App {
  ...
  println("How about the com.github.AnitaBe.Fingers?")
