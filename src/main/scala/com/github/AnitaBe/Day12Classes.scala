package com.github.AnitaBe
  ...
  /**
   * Describes a blueprint for a generic com.github.AnitaBe.House
   * @param name - com.github.AnitaBe.House name
  ...
  //from com.github.AnitaBe.Day12Classes defintion
  object Day12Classes extends App {
    ...
    val myPlainHouse = new PlainHouse //this creates an object instances out of com.github.AnitaBe.PlainHouse blueprint
    println(myPlainHouse)
    val anotherPlainHouse = new PlainHouse //this is a second object out of our com.github.AnitaBe.PlainHouse class blueprint
    ...
    //i create another object out of com.github.AnitaBe.House class blueprint
